<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page isELIgnored="false" %>
        ...
        <body>
                  ...
                  <div class="container">
                      <div class="column">
                          <img id="imagePre" src="" alt="圖片1"><br>

                          <div class="text">
                              <h2> About Us </h2>
                              <span id="editContent" contenteditable="false">
                                  忙碌的現代社會中，總是為了方便而選擇外食，但是自己動手做，不僅滿足吃甜食的慾望，更能夠揮灑自己的創意和想像力，自己創造甜點、享受、分享。
                                  <br>
                              ...
                              <button type="button" id="edit"><svg xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  編輯</button>
                              <button type="button" id="save" style="display: none;"><svg
                                  ...
                                  保存</button>
                                    <button type="button" id="changeImage" style="display: none;"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                 ...
                                 save.addEventListener('click', function () {
                                     ...
                                     var formData = {
                                            ...
                                            function saveData() {
                                                $.ajax({
                                                    method: 'post',
                                                    url: '/diyla_back/aboutusContro?content=',
                                        ...
                                        imagePre.src = "../img/cake-svgrepo-com.svg";
                                    </script>
